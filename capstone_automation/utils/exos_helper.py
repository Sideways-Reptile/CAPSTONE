...
HQ_SWITCHES = {
    "HQ-SW1-Core":     {"ip": "10.10.10.21", "role": "core",         "stp_priority": 4096},
    "HQ-SW2-Dist":     {"ip": "10.10.10.22", "role": "distribution", "stp_priority": 8192},
    "HQ-SW3-Access-1": {"ip": "10.10.10.23", "role": "access",       "stp_priority": 32768},
    "HQ-SW4-Access-2": {"ip": "10.10.10.24", "role": "access",       "stp_priority": 32768},
    "HQ-SW5-Access-3": {"ip": "10.10.10.25", "role": "access",       "stp_priority": 32768},
}
...
class EXOSSwitch:
    ...
    Usage:
        with EXOSSwitch("10.10.10.21") as sw:
