...
STATIC_HOSTS = [
    ...
    # HQ Switch MGMT IPs
    {"label": "HQ-SW1-Core",            "ip": "10.10.10.21",   "required": True},
    {"label": "HQ-SW2-Dist",            "ip": "10.10.10.22",   "required": True},
    {"label": "HQ-SW3-Access-1",        "ip": "10.10.10.23",   "required": True},
    {"label": "HQ-SW4-Access-2",        "ip": "10.10.10.24",   "required": True},
    {"label": "HQ-SW5-Access-3",        "ip": "10.10.10.25",   "required": True},
    # Ubu-WS01
