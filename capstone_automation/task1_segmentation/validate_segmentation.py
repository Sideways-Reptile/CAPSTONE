...
REACHABILITY_TESTS = [
    ...
    ("MGMT → SW1-Core",         "10.10.10.21",   True,  "SW1-Core reachable from MGMT"),
    ("MGMT → SW2-Dist",         "10.10.10.22",   True,  "SW2-Dist reachable from MGMT"),
    ("MGMT → SW3-Access-1",     "10.10.10.23",   True,  "SW3-Access-1 reachable from MGMT"),
    ("MGMT → SW4-Access-2",     "10.10.10.24",   True,  "SW4-Access-2 reachable from MGMT"),
    ("MGMT → SW5-Access-3",     "10.10.10.25",   True,  "SW5-Access-3 reachable from MGMT"),
]

SSH_TESTS = [
    ("SSH to HQ-FW1",   "10.10.10.1",  22, True),
    ("SSH to SW1-Core", "10.10.10.21", 22, True),
    ("SSH to SW2-Dist", "10.10.10.22", 22, True),
    ("SSH to SW3",      "10.10.10.23", 22, True),
    ("SSH to SW4",      "10.10.10.24", 22, True),
    ("SSH to SW5",      "10.10.10.25", 22, True),
]
